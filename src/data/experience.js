export const experiences = [
  {
    ...
    title: "QA Engineer Intern, IDEMIA Public Security",
    tag: "Internship",
    summary:
    ...
    body: [
      "My role is QA Engineer Intern, but I noticed a repetitive QA bottleneck that was causing multi-day updates and after-hours work — so instead of just living with it, I proposed and built my own fix, independently initiating two internal AI automation projects.",
